    ...
    public partial class SeedAllTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { -3, -1, new DateTime(2020, 10, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2020, 10, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), null });

            migrationBuilder.InsertData(
                table: "borrow",
                columns: new[] { "ID", "BookID", "CheckedOutDate", "DueDate", "ReturnedDate" },
                values: new object[] { -2, -2, new DateTime(2020, 10, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2020, 10, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2020, 10, 14, 0, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "borrow",
                columns: new[] { "ID", "BookID", "CheckedOutDate", "DueDate", "ReturnedDate" },
                values: new object[] { -1, -3, new DateTime(2020, 10, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2020, 10, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2020, 10, 15, 0, 0, 0, 0, DateTimeKind.Unspecified) });
        }
